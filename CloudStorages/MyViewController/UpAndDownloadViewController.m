...
- (void)navigaterBarItemInit{
    ...
    [_choosBtn setTitle:@"Select multiple files" forState:UIControlStateNormal];
    ...
    [btn2 setTitle:@"Start to upload" forState:UIControlStateNormal];
...
- (void)uploadArr{
    if (_arrChoose) {
       ...
       self.title = @"Upload single file";
        ...
        _arrChoose = YES;
         [_choosBtn setTitle:@"Select single file" forState:UIControlStateNormal];
        self.title = @"Upload multiple files";
    }
