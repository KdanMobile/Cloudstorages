...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"description is %@",[servers description]);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (isUpload) {
        ...
        } else if (CSICloud == _server.serverType) {
...
- (void)serverLoginFaile:(CSCloudServer *)server withError:(NSError *)error{
    self.title = nil;
    UIAlertView * alt  = [[UIAlertView alloc] initWithTitle:nil message:@"登录失败" delegate:self cancelButtonTitle:@"确定" otherButtonTitles: nil];
