...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIActionSheet *chooseSheet = [[[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"cancel" destructiveButtonTitle:nil otherButtonTitles:@"暂停下载",@"开始下载",@"删除任务", nil] autorelease];
...
#pragma mark - my
- (void)edit{
    UIAlertView * alt = [[UIAlertView alloc]initWithTitle:@"编辑" message:@"选择" delegate:self cancelButtonTitle:@"ok" otherButtonTitles:@"开始下载",@"删除已完成任务", nil];
    [alt show];
    [alt release];
}
